...
# Settings
NAME = libedgeimpulse.so
BUILD_PATH = ./build

# Location of ei_inference.cpp (must use C++ compiler for main)
CXXSOURCES = source/ei_inference.cpp
